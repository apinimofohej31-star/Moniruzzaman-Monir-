...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "miss u too": "হুম আমি ও তোমাকে Miss করি... কিন্তু মনির বস বেশি করে 😏💖",
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ MONIR ☜\nFacebook: https://www.facebook.com/profile.php?id=100041565340635\nWhatsApp: +880SAHU1618959120",
    "admin": "He is MONIR তাকে সবাই Admin MONIR হিসেবে চিনে😘☺️",
    ...
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস মনির কে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    "i love you": "মেয়ে হলে আমার বস মনির এর ইনবক্সে এখুনি গুঁতা দিন🫢😻",
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss মনির এর ইনবক্সে গুতা দিন 😘",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌Monir💖",
    ...
    "ki koros": "বস মনির এর সাথে প্রেমে ব্যস্ত আছি 😏💘",
    ...
    "love": "Love করলে সরাসরি মনির বস কে বল জানু 😻🔥"
  };if  if (!responses[msg]) return;
